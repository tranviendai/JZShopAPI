        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(74)", maxLength: 74, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryChild_Category_CategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipID = table.Column<string>(type: "nvarchar(10)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    VoucherID = table.Column<string>(type: "nvarchar(10)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bill", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bill_Ship_ShipID",
                        column: x => x.ShipID,
                        principalTable: "Ship",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Material = table.Column<string>(type: "nvarchar(24)", maxLength: 24, nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DiscountPercent = table.Column<double>(type: "float", nullable: true),
                    CategoryChildID = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Product_CategoryChild_CategoryChildID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "2ccdcef3-db18-46c7-b5ff-910be6ae4906", null, "EMPLOYEE", "EMPLOYEE" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "AccessFailedCount", "Address", "Birthday", "ConcurrencyStamp", "DateCreated", "Email", "EmailConfirmed", "FullName", "Image", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "Type", "UserName" },
                values: new object[] { "a79e98b4-d8a6-4640-98eb-5b417ffb2661", 0, "Tắc Vân - Cà Mau", new DateTime(2023, 6, 23, 0, 5, 37, 852, DateTimeKind.Local).AddTicks(9657), "87716d43-f568-44ec-a8fc-1f39af9eb316", new DateTime(2023, 6, 23, 0, 5, 37, 852, DateTimeKind.Local).AddTicks(9669), "admin@gmail.com", true, "Trần Viễn Đại", "https://www.nicepng.com/png/full/128-1280406_view-user-icon-png-user-circle-icon-png.png", false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAED4UABAcQ1TneNIMBLns7mDeqORleQj379w8jLcSqwtE5GF815GtCDo+WFzhbnOB8Q==", "0582072743", false, "00ab1284-edd7-4793-8993-d8555f5b67ef", false, null, "admin@gmail.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryChild_CategoryID",
                table: "CategoryChild",
                column: "CategoryID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_CategoryChildID",
                table: "Product",
